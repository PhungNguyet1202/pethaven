                  ...
                  <strong class="d-flex justify-content-between">
                    ...
                    <div>
                      <span class="badge text-bg-warning">
                        <i class="far fa-box"></i> {{$dh->total_quanlity}}
                      </span>
                      <span class="badge bg-success-subtle text-success"><i class="far fa-money-bill-wave">{{number_format($dh->total_money)}}</i> </span>
                    </div>
                  </strong>
                  Đặt bởi <i>{{$dh->user_fullname}}</i> {{$dh->created_at->format('H:i d/m/y')}}
                </a>
              </div>
          @endforeach
            </div>
